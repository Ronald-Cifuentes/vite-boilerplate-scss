...
| JS Bundle (raw)   | <= 244 KB | Rev. 11: one-time honest headroom (floor 241,015 after all verified trims; register-prescribed so downstream projects do not inherit a zero-headroom cap); warning 243 KB |
...
| 2026-07-12 | Orchestrator recording project-owner approval (task-21 closeout)  | Rev. 11: raw 241→244 KB (warning 243), gzip unchanged 76 KB (floor 75,836). One-time honest-headroom revision prescribed by FOUNDATION-FLAWS-REGISTER (BUNDLE-CAP): a 15 B latent overage accumulated across cleanup refactors surfaced at the task-21 gate; verified trims applied first (duplicate locale-persistence write removed; final default export removed); chunk caps unchanged — feature-sized growth still goes to lazy chunks.                                                                                                           |
